...
import PerYearStatsCount from 'components/statistics/PerYearStatsCount';
import BreakdownCharts from 'components/statistics/BreakdownCharts';
import HighestRatedMoviesFromYear from 'components/statistics/HighestRatedMoviesFromYear';
